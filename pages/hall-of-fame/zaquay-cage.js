...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>CodingPhase | ZaQuay Cage</title>
              ...
              <div className="row">
                ...
                <div className="col-md-6">
                  <div className="hof-page-user__info">
                    <span className="hof-page-user__name">ZaQuay Cage</span>
                    <span className="hof-page-user__career">Web Systems Engineer at IMAX</span>
                    ...
                    <div className="relevant-links">
                      ...
                      <ul>
                        {/* <li><a href="https://daniel-bellfield.com/" className="relevant-links__link">Portfolio</a> 
                        </li>*/}
